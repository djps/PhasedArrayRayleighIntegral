/*
This class defines a  spherical bowl with circular piston transducers on it.  I assume that the centre of this sphere 
is at the origin, and that the transducer is entirely contained in the z<0 plane. I also assume that the centres of 
the circular pistons are on the sphere, and they are oriented towards the origin.
...
NOTES:
This class inherits almost everything from Optimize_Transducer. The only things that are new are setting up the layout 
of the elements and initializing the pointers to the elements. We also need a radius of curvature, and we shall need 
several methods of laying out the transducers. These go into the Setup_Transducer routine. 
*/
...
class Circular_Piston_Transducer : public Optimize_Transducer
{
	...
	public:
		...
		void Setup_Transducer(string &filename); 
