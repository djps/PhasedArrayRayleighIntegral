/*
This class specifies the base class TransducerElement to the case where the curvature of the element face 
is spherical. I assume that the focus of this sphere is at the origin, and that the transducer is entirely 
 ...
 */
	...
	public:
		...
		// stupid default destructor. Doesn't do anything. Reason is that all non-automatic variables are 
		// deleted by the Transducer_Element class. 
		~Circular_Piston_Element()
		{ 
#ifdef DEBUG2
